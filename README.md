...
combinations, and the identifier is easy to read aloud and type back into the resume flag (added in
an upcoming change) if a run needs to be continued after a crash.
